...
object OraConn extends Serializable {
  ...
  try {
    ...
    props.setProperty("url", properties.getProperty("ora.url"))
    props.setProperty("username", properties.getProperty("ora.usr"))
    props.setProperty("password", properties.getProperty("ora.pwd"))
